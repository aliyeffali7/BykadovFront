export type Category = {
  ...
  iconImage?: string
  color: string
  cardImage: string   // background image shown on category cards
  products: Product[]
}
...
export type Product = {
  ...
  description?: string
  details?: string[]
  dateAdded?: string   // ISO date string, e.g. '2026-03-25'
  categorySlug?: string // set dynamically on all-products page
}
...
export const categories: Category[] = [
  {
    ...
    cardImage: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fit=crop&w=800&q=80',
    products: [
      { id: 1, name: 'Kətan Geniş Köynək', price: 67, badge: 'Yeni', dateAdded: '2026-03-27' },
      { id: 2, name: 'Geniş Balaq Şalvar', price: 89, dateAdded: '2026-03-20' },
      ...
      { id: 8, name: 'Açıq Arxa Kətan Bluz', price: 72, badge: 'Yeni', dateAdded: '2026-03-15' },
  ...
  },
  {
    ...
    cardImage: 'https://images.unsplash.com/photo-1609709295948-17d77cb2a69b?auto=format&fit=crop&w=800&q=80',
    products: [
      { id: 1, name: 'İpək Bandana Şərfi', price: 38, badge: 'Yeni', dateAdded: '2026-03-26' },
      { id: 2, name: 'Geniş Kənarlı Günəş Papağı', price: 52, dateAdded: '2026-03-18' },
      ...
      { id: 6, name: 'Böyük Günəş Eynəyi', price: 65, badge: 'Yeni', dateAdded: '2026-03-22' },
  ...
  },
  {
    ...
    color: 'rgba(221,188,117,0.10)',
    cardImage: 'https://images.unsplash.com/photo-1568515387631-8b650bbcdb90?auto=format&fit=crop&w=800&q=80',
    products: [
      { id: 1, name: 'Çiçəkli Sarmaşıq Dəsti (12 ədəd)', price: 12, badge: 'Populyar' },
      { id: 2, name: 'Həndəsi Əjdaha', price: 9, badge: 'Yeni', dateAdded: '2026-03-24' },
  ...
  },
  {
    ...
    cardImage: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?auto=format&fit=crop&w=800&q=80',
    products: [
      { id: 1, name: 'Əl İşi Keramik Vaza', price: 48, badge: 'Yeni', dateAdded: '2026-03-25' },
  ...
  },
  {
    ...
    cardImage: 'https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?auto=format&fit=crop&w=800&q=80',
    products: [
      { id: 1, name: 'Qızıl Zəncir Boyunbağı — 18k', price: 89, badge: 'Yeni', dateAdded: '2026-03-28' },
      ...
      { id: 5, name: 'Qalın Qızıl Halqa Sırğalar', price: 48, badge: 'Yeni', dateAdded: '2026-03-23' },
  ...
  },
  {
    ...
    cardImage: 'https://images.unsplash.com/photo-1596462502278-27bfdc403348?auto=format&fit=crop&w=800&q=80',
    products: [
      { id: 1, name: 'İtburnu Üz Yağı 30ml', price: 44, badge: 'Populyar' },
      { id: 2, name: 'C Vitamini Serumu', price: 52, badge: 'Yeni', dateAdded: '2026-03-21' },
      ...
      { id: 6, name: 'Retinol Gecə Kremi', price: 67, badge: 'Yeni', dateAdded: '2026-03-16' },
  ...
  },
  {
    ...
    icon: '👜',
    color: 'rgba(221,188,117,0.09)',
    cardImage: 'https://images.unsplash.com/photo-1548036328-c9fa89d128fa?auto=format&fit=crop&w=800&q=80',
    products: [
      { id: 1, name: 'Mini Yapışıq Çiyin Çantası', price: 115, badge: 'Yeni', dateAdded: '2026-03-19' },
      ...
      { id: 5, name: 'Zəncir Qayışlı Çiyin Çantası', price: 134, badge: 'Yeni', dateAdded: '2026-03-14' },
  ...
  },
  {
    ...
    icon: '👠',
    color: 'rgba(221,188,117,0.08)',
    cardImage: 'https://images.unsplash.com/photo-1543163521-1bf539c55dd2?auto=format&fit=crop&w=800&q=80',
    products: [
      { id: 1, name: 'Blok Topuqlu Mule — Bej', price: 89, badge: 'Yeni', dateAdded: '2026-03-17' },
  ...
  },
  {
    ...
    icon: '🌸',
    color: 'rgba(221,188,117,0.08)',
    cardImage: 'https://images.unsplash.com/photo-1592945403244-b3fbafd7f539?auto=format&fit=crop&w=800&q=80',
    products: [
      { id: 1, name: 'Oud & Kəhrəba EDP 50ml', price: 95, badge: 'Populyar' },
      { id: 2, name: 'Rose Noir Parfum 30ml', price: 78, badge: 'Yeni', dateAdded: '2026-03-13' },
      { id: 3, name: 'Sitrus Çiçəyi EDP 75ml', price: 62 },
      { id: 4, name: 'Vanil Müşk EDP 50ml', price: 71 },
      { id: 5, name: 'Sidr & İris EDP', price: 88, badge: 'Yeni', dateAdded: '2026-03-10' },
  ...
  },
  {
    ...
    cardImage: 'https://images.unsplash.com/photo-1490481651871-ab68de25d43d?auto=format&fit=crop&w=800&q=80',
    products: [
      { id: 1, name: 'Bahar Kolleksiyası Hədiyyə Qutusu', price: 89, badge: 'Məhdud' },
      { id: 2, name: 'Yay Kətan Dəsti', price: 120, badge: 'Yeni', dateAdded: '2026-03-12' },
      ...
      { id: 10, name: 'Ramazan Kolleksiyası', price: 110, badge: 'Yeni', dateAdded: '2026-03-11' },
